...
@WebService(name = "EndpointInterface",targetNamespace = "br.com.vectorx.teste1.ws.ICalendarWS", serviceName = "CalendarWS")
@SOAPBinding(style=Style.DOCUMENT)
@Remote(ICalendarWS.class)
@Stateless
public class CalendarWS implements ICalendarWS{
